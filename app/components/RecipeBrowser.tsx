    ...
    <div className="space-y-6">
      ...
      <div className="text-center space-y-2">
        <div className="flex items-center justify-center gap-2">
          ...
          <h2 className="text-3xl font-bold text-gray-900">Ayurvedic Recipe Library</h2>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-4 items-center">
            ...
            <select
              ...
              className="px-4 py-2 pr-10 rounded-lg border-2 border-gray-200 focus:border-emerald-500 focus:outline-none text-sm min-w-[160px] bg-white appearance-none cursor-pointer hover:border-emerald-300 transition-colors"
              style={{ 
