    ...
    return (
      <div className="relative overflow-hidden bg-gradient-to-br from-white via-emerald-50/30 to-teal-50/50 rounded-3xl shadow-2xl border border-emerald-100/50 backdrop-blur-sm">
        ...
        <div className="relative p-12 text-center">
          ...
          <h3 className="text-2xl font-bold text-gray-800 mb-4 bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-transparent">
            Your Personalized Diet Plan Awaits
          </h3>
          <p className="text-gray-600 leading-relaxed text-lg max-w-md mx-auto">
            Complete the form to generate your personalized Ayurvedic diet plan tailored to your unique constitution and wellness goals.
          </p>
      ...
      <div className="relative p-8">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 text-lg leading-relaxed max-w-2xl mx-auto">
            Personalized nutrition based on your unique constitution and ancient Ayurvedic wisdom
          </p>
         ...
         dietPlan.dinner.length === 0 && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-500 max-w-lg mx-auto leading-relaxed text-lg">
              ...
              Please try a different constitution or contact our support team for personalized guidance.
            </p>
          </div>
        )}
      </div>
