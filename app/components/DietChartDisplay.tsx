...
export default function DietChartDisplay({ dietPlan, patientProfile, nutritionalSummary }: DietChartDisplayProps) {
    ...
    return (
      <div className="relative overflow-hidden bg-gradient-to-br from-white via-emerald-50/30 to-teal-50/50 dark:from-gray-800 dark:via-gray-800 dark:to-gray-900 rounded-3xl shadow-2xl border border-emerald-100/50 dark:border-gray-700 backdrop-blur-sm">
        ...
        <div className="relative p-12 text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 leading-relaxed text-lg max-w-md mx-auto">
  ...
  const getMealIcon = (mealType: string) => {
    switch (mealType) {
      ...
      default:
        return <Utensils className="w-6 h-6 text-gray-600 dark:text-gray-400" />;
    }
  };
  ...
  const getVirya = (virya: string) => {
    return virya === 'Heating' ? (
      <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold bg-gradient-to-r from-red-100 to-orange-100 dark:from-red-900/30 dark:to-orange-900/30 text-red-700 dark:text-red-300 border border-red-200/50 dark:border-red-800/50 shadow-sm">
        <Flame className="w-4 h-4" />
        Heating
      </span>
    ) : (
      <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold bg-gradient-to-r from-blue-100 to-cyan-100 dark:from-blue-900/30 dark:to-cyan-900/30 text-blue-700 dark:text-blue-300 border border-blue-200/50 dark:border-blue-800/50 shadow-sm">
  ...
  const getDigestibility = (digestibility: string) => {
    return digestibility === 'Easy' ? (
      <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold bg-gradient-to-r from-green-100 to-emerald-100 dark:from-green-900/30 dark:to-emerald-900/30 text-green-700 dark:text-green-300 border border-green-200/50 dark:border-green-800/50 shadow-sm">
        <Zap className="w-4 h-4" />
        Easy
      </span>
    ) : (
      <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold bg-gradient-to-r from-yellow-100 to-amber-100 dark:from-yellow-900/30 dark:to-amber-900/30 text-yellow-700 dark:text-yellow-300 border border-yellow-200/50 dark:border-yellow-800/50 shadow-sm">
  ...
  const renderMealSection = (title: string, foods: Food[]) => {
    ...
    return (
      <div className="relative mb-12">
        <div className={`relative overflow-hidden bg-gradient-to-br ${getMealBg(title)} dark:from-gray-800/80 dark:via-gray-800/60 dark:to-gray-900/80 rounded-3xl shadow-xl border border-white/50 dark:border-gray-700/50 backdrop-blur-sm`}>
          <div className="absolute inset-0 bg-gradient-to-br from-white/20 dark:from-white/5 via-transparent to-white/10 dark:to-white/5"></div>
          ...
          <div className="relative p-8">
            ...
            <div className="grid gap-6">
              {foods.map((food, index) => (
                <div key={food.id} className="group relative overflow-hidden bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-lg border border-white/60 dark:border-gray-700/60 hover:shadow-2xl hover:scale-[1.02] transition-all duration-500">
                  <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 dark:via-white/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-start justify-between gap-6">
                      <div className="flex-1">
                        <div className="flex items-start gap-4 mb-4">
                          ...
                          <div className="flex-1">
                            <h4 className="text-xl font-bold text-gray-800 dark:text-white mb-2 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors duration-300">
                              {food.name}
                            ...
                            <div className="flex flex-wrap gap-3 mb-4">
                              ...
                              <span className="px-3 py-1 rounded-full text-sm font-medium bg-gradient-to-r from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-700 text-gray-700 dark:text-gray-300 border border-gray-200/50 dark:border-gray-600/50">
                                {food.category}
                              </span>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {food.ayurvedic.rasa.map((rasa, index) => (
                              <span key={index} className="px-3 py-1 rounded-lg text-sm font-medium bg-gradient-to-r from-emerald-50 to-teal-50 dark:from-emerald-900/30 dark:to-teal-900/30 text-emerald-700 dark:text-emerald-300 border border-emerald-200/50 dark:border-emerald-800/50 shadow-sm">
                                {rasa}
                              </span>
                            ))}
                          </div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex flex-wrap gap-2">
                            {food.ayurvedic.guna.map((guna, index) => (
                              <span key={index} className="px-3 py-1 rounded-lg text-sm font-medium bg-gradient-to-r from-teal-50 to-cyan-50 dark:from-teal-900/30 dark:to-cyan-900/30 text-teal-700 dark:text-teal-300 border border-teal-200/50 dark:border-teal-800/50 shadow-sm">
                                {guna}
                              </span>
                            ))}
                          </div>
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-wrap gap-3 justify-end print:hidden">
        <button
          onClick={handlePrint}
          className="flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 rounded-lg transition-colors duration-200 shadow-sm hover:shadow-md"
        >
      ...
      {dietPlan.guidelines && dietPlan.guidelines.length > 0 && (
        <div className="relative overflow-hidden bg-gradient-to-br from-white via-amber-50/30 to-orange-50/50 dark:from-gray-800 dark:via-gray-800 dark:to-gray-900 rounded-3xl shadow-2xl border border-amber-100/50 dark:border-gray-700 backdrop-blur-sm">
          <div className="absolute inset-0 bg-gradient-to-br from-amber-500/5 via-transparent to-orange-500/5 dark:from-amber-500/10 dark:to-orange-500/10"></div>
          <div className="relative p-8">
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 bg-gradient-to-br from-amber-400 to-orange-500 rounded-xl flex items-center justify-center shadow-lg">
                <BookOpen className="w-6 h-6 text-white" />
              </div>
              <h3 className="text-2xl font-bold text-gray-800 dark:text-white">Ayurvedic Guidelines</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {dietPlan.guidelines.map((guideline, index) => (
                <div key={index} className="flex items-start gap-3 p-4 bg-white/60 dark:bg-gray-900/60 rounded-xl border border-amber-200/50 dark:border-gray-700/50">
                  ...
                  <p className="text-gray-700 dark:text-gray-300 text-sm leading-relaxed">{guideline}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      {dietPlan.mealTimings && dietPlan.mealTimings.length > 0 && (
        <div className="relative overflow-hidden bg-gradient-to-br from-white via-indigo-50/30 to-blue-50/50 dark:from-gray-800 dark:via-gray-800 dark:to-gray-900 rounded-3xl shadow-2xl border border-indigo-100/50 dark:border-gray-700 backdrop-blur-sm">
          <div className="absolute inset-0 bg-gradient-to-br from-indigo-500/5 via-transparent to-blue-500/5 dark:from-indigo-500/10 dark:to-blue-500/10"></div>
          <div className="relative p-8">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-2xl font-bold text-gray-800 dark:text-white">Recommended Meal Timings</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {dietPlan.mealTimings.map((timing, index) => (
                <div key={index} className="bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm rounded-2xl p-6 border border-indigo-200/50 dark:border-gray-700/50 shadow-lg">
                  <div className="text-center mb-4">
                    ...
                    <h4 className="text-lg font-bold text-gray-800 dark:text-white capitalize mb-2">{timing.meal}</h4>
                    <div className="text-2xl font-bold text-indigo-600 dark:text-indigo-400 mb-2">{timing.recommendedTime}</div>
                  </div>
                  <p className="text-sm text-gray-600 dark:text-gray-400 text-center leading-relaxed">{timing.description}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-white via-emerald-50/30 to-teal-50/50 dark:from-gray-800 dark:via-gray-800 dark:to-gray-900 rounded-3xl shadow-2xl border border-emerald-100/50 dark:border-gray-700 backdrop-blur-sm">
      <div className="absolute inset-0 bg-gradient-to-br from-emerald-500/5 via-transparent to-teal-500/5 dark:from-emerald-500/10 dark:to-teal-500/10"></div>
      <div className="absolute top-0 right-0 w-64 h-64 bg-gradient-to-br from-emerald-200/10 dark:from-emerald-600/5 to-teal-200/10 dark:to-teal-600/5 rounded-full -translate-y-32 translate-x-32"></div>
        ...
        {dietPlan.breakfast.length === 0 && 
         ...
         dietPlan.dinner.length === 0 && (
          <div className="text-center py-16">
            <div className="w-24 h-24 mx-auto mb-8 bg-gradient-to-br from-gray-200 to-gray-300 dark:from-gray-700 dark:to-gray-800 rounded-full flex items-center justify-center shadow-lg">
              <Utensils className="w-12 h-12 text-gray-500 dark:text-gray-400" />
            </div>
            <h3 className="text-2xl font-bold text-gray-700 dark:text-gray-300 mb-4">
              No Suitable Foods Found
            </h3>
            <p className="text-gray-500 dark:text-gray-400 max-w-lg mx-auto leading-relaxed text-lg">
